<div class="container-fluid tab-pane fade" id="routerList">
    <button type="button" class="btn btn-primary py-1" data-bs-toggle="modal" data-bs-target="#newHardware">New Router</button>

    <table class="table caption-top container-xl">
      <caption class="py-1">Router</caption>
