<div class="container-fluid tab-pane fade" id="accessPointList">
    <button type="button" class="btn btn-primary py-1" data-bs-toggle="modal" data-bs-target="#newHardware">New Access Point</button>

    <table class="table caption-top container-xl">
      <caption class="py-1">Access Point</caption>
