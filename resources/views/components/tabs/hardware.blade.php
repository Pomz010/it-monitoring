...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
  ...
  @endforeach
    ...
    <button type="button" class="btn btn-primary py-1" data-bs-toggle="modal" data-bs-target="#newHardware">New Hardware</button>
    <button type="button" class="btn btn-primary py-1" data-bs-toggle="modal" data-bs-target="#newCategory">New Category</button>
